...
Private Sub mniExcluir_Click()
    ...
    Else
        ...
        stbCliente.Panels.Item(1).Text = "Registro Excluído com Êxito."
        Call ZeraValores
        Call QueryMain
...
Private Sub mniSalvar_Click()
    ...
    Else
        Call Time
        tmrCliente.Enabled = True
        stbCliente.Panels.Item(1).Text = "Registro Gravado com Êxito."
        Call QueryMain
        If Conn.NumErro <> 0 Then
            MsgBox "Não foi Possível Reler os Dados." _
                & Chr(13) & Me.Caption & " Será Fechado."
...
Public Sub Load()
    ...
    Do While Not Conn.Rs.EOF
        ...
        Rows = Rows + 1
    Loop
    frmLocalizar.Caption = "Localização de Cliente"
