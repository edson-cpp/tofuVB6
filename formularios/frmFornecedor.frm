...
Private Sub mebCnpj_Validate(Cancel As Boolean)
    ...
    If Cancel Then
        MsgBox "Número de CNPJ Inválido", vbInformation, "CNPJ Inválido"
    End If
End Sub
...
Private Sub mniExcluir_Click()
    ...
    Else
        ...
        stbFornecedor.Panels.Item(1).Text = "Registro Excluído com Êxito."
        Call ZeraValores
        Call QueryMain
...
Private Sub mniSalvar_Click()
    ...
    Else
        Call Time
        tmrFornecedor.Enabled = True
        stbFornecedor.Panels.Item(1).Text = "Registro Gravado com Êxito."
        Call QueryMain
        If Conn.NumErro <> 0 Then
            MsgBox "Não foi Possível Reler os Dados." _
                & Chr(13) & Me.Caption & " Será Fechado."
